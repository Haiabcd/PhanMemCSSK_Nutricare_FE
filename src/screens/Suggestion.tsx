...
import {
  ...
  StyleSheet,
  useWindowDimensions,
  ScrollView, // cuộn ngang cho filters
} from 'react-native';
      ...
      return (
        <View style={styles.cardWrap}>
          <View style={styles.card}>
            {/* Ảnh banner + badge góc phải */}
            <View style={styles.thumbWrap}>
              <Image source={{ uri: item.image }} style={styles.thumb} resizeMode="cover" />
              <View style={styles.badge}>
                <Text style={styles.badgeText}>Món ăn</Text>
              </View>
            </View>
  ...
  return (
    <Container>
      ...
      <View style={styles.topBar}>
        ...
        <Text style={styles.topSub}>Chọn món hợp mục tiêu · Lọc nhanh theo calo & protein</Text>
      </View>

      {/* ===== “Bao” trắng: search + filters + list ===== */}
      <View style={[styles.contentBlock, { height: CONTENT_HEIGHT }]}>
        ...
        {/* Filters — hàng ngang CUỘN, đặt ngay dưới search (không giãn) */}
        <ScrollView
          horizontal
        ...
        >
          ...
          <Pressable
            ...
            style={[styles.chip, onlyLowCal && styles.chipActive]}
          >
          ...
          <Pressable
            ...
            style={[styles.chip, onlyHighProtein && styles.chipActive]}
          >
...
const s = StyleSheet.create({
  ...
  avatarFallback: {
    width: 52, height: 52, borderRadius: 999, backgroundColor: C.bg,
    borderWidth: 1, borderColor: C.border,
  },
...
const styles = StyleSheet.create({
  ...
  topTitle: { fontSize: 20, fontWeight: '800', letterSpacing: 0.1, color: colors.text },
  topSub: { color: colors.sub, fontSize: 13, marginTop: 2 },

  contentBlock: {
    flexGrow: 0, minHeight: 0, marginBottom: 12,
    backgroundColor: colors.card, borderRadius: 16,
    borderWidth: 1, borderColor: colors.border,
    shadowColor: '#000', shadowOpacity: 0.06, shadowRadius: 10,
    shadowOffset: { width: 0, height: 2 }, elevation: 2,
    overflow: 'hidden',
    paddingTop: 10, paddingBottom: 10, // để strip áp sát search
  },

  // SEARCH
  searchWrap: {
    marginHorizontal: 12, height: 42, backgroundColor: colors.card,
    borderRadius: 999, paddingHorizontal: 14, alignItems: 'center',
    flexDirection: 'row', gap: 8, borderWidth: 1, borderColor: colors.border,
  },
  searchInput: { flex: 1, color: colors.text, paddingVertical: 8, fontWeight: '600' },

  // FILTER STRIP (ngang) — set chiều cao cố định để KHÔNG bị giãn
  ...
  chipActive: {
    ...
    shadowColor: colors.primary, shadowOpacity: 0.14, shadowRadius: 6,
    shadowOffset: { width: 0, height: 2 }, elevation: 2,
  },
  ...
  cardTitle: { fontSize: 16, fontWeight: '900', color: colors.text, letterSpacing: 0.15 },
  ...
  metaText: { fontSize: 12, color: colors.text, fontWeight: '700' },
  ...
  emptyBtn: {
    marginTop: 14, backgroundColor: colors.primary, paddingHorizontal: 16,
