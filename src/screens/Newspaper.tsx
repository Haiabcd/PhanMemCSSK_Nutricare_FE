            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={s.scroll}>
                <ViewComponent row alignItems="center" mt={8} mb={12}>
                    ...
                    <View style={s.singleChip}>
                        <TextComponent text="Bài báo" weight="bold" size={12} color={C.onPrimary} />
                    </View>
                </ViewComponent>
                ...
                <TextComponent text="Bài viết liên quan" variant="h3" weight="bold" style={s.relatedTitle} />
                <View style={s.relatedGrid}>
                    {related.map((r) => (
                        <Pressable key={r.id} style={s.relatedCard} onPress={() => { /* điều hướng chi tiết nếu cần */ }}>
                            <Image source={{ uri: r.img }} style={s.relatedImg} />
                            <View style={s.relatedBody}>
                                <TextComponent text={r.title} numberOfLines={2} weight="bold" />
                                <TextComponent text={r.read} size={12} tone="muted" mt={6} />
                            </View>
                        </Pressable>
                    ))}
                </View>
