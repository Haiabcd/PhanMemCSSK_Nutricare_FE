...
export const StepConditionScreen = () => {
  ...
  const suggestions = useMemo(() => {
    ...
    return SUGGESTED_CONDITIONS.filter(s =>
  ...
  return (
    ...
    >
        ...
        <View style={[styles.card, { flex: 1 }]}>
          <View style={styles.cardHeader}>
            <Text style={styles.sectionLabel}>Bệnh nền đã chọn ({form.allergies.length})</Text>
          ...
          {form.allergies.length === 0 ? (
            <View style={styles.empty}>
              <Text style={styles.emptyText}>Chưa có bệnh nền nào được thêm.</Text>
              <Text style={styles.emptySub}>Nhập bệnh nền hoặc chọn từ gợi ý bên trên.</Text>
            </View>
          ) : (
